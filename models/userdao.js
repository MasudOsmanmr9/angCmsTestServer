...
class usersDao {
    ...
    async findUser(userInfo) {
        ...
        console.log('accessing',userInfo)
        let result = await this.getDataDetails('users',userInfo)
        console.log('finduserssssssssss',result);
    ...
    async createUser(user) {
        ...
        let result = await this.saveData(user);
        return result;
    }
